...
async def run_bot(
    ...
    system_instruction = (
        ...
        "Before calling place_order, read the full order back: every cake with its "
        ...
        "- You ONLY take new cake orders for delivery. You cannot look up, change, or "
        ...
        "- You only help with ordering cakes. Politely decline anything else and steer "
        "back to the order.\n\n"
